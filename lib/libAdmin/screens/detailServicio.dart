...
class DetailServicio extends StatefulWidget {
  ...
  DetailServicio({super.key, required this.index, required this.list});

  @override
  _DetailServicioState createState() => _DetailServicioState();
}
...
class _DetailServicioState extends State<DetailServicio> {
  ...
  Future<List> _loadData() async {
    ...
    try {
      ...
      var apiUrl = 'http://34.171.207.241/proyecto1/api/client/$idServicio';
