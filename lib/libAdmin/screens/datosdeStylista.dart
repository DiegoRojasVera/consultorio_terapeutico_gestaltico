...
import 'detailStylist.dart';

class DatosEstilista extends StatefulWidget {
  const DatosEstilista({super.key});

  @override
  _DatosEstilistaState createState() => _DatosEstilistaState();
}

// pedimos el correo para selecciona solo un usuario
class _DatosEstilistaState extends State<DatosEstilista> {
  List? data;
  User? user;
  bool loading = true;
        ...
        return Container(
          ...
          child: GestureDetector(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(
                builder: (BuildContext context) => DetailStylist1(
                  list: list,
                  index: i,
                ),
              ),
