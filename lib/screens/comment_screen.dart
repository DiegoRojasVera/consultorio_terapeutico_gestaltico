...
import 'package:consultorio_terapeutico_gestaltico/models/comment.dart';
import 'package:consultorio_terapeutico_gestaltico/services/comment_service.dart';
...
class _CommentScreenState extends State<CommentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loading
          ? const Center(
              child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Utils.secondaryColor)),
            )
          : Column(children: [
              Expanded(
